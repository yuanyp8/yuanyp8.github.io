        ...
        <svg
            ...
            <g
                ...
                <path
                    fill="#C3C2C2"
                    strokeMiterlimit="10"
                    d="M321.607 172.201l52.879-29.132c4.864-2.679 10.989-.906 13.668 3.959l33.747 61.262c2.679 4.865.906 10.989-3.958 13.669l-52.879 29.132c-4.864 2.679-10.989.906-13.668-3.959l-33.747-61.262c-2.679-4.865-.906-10.989 3.958-13.669z"></path>
                <path
                    fill="#DBD5FF"
                    strokeMiterlimit="10"
                ...
                <g>
                    ...
                    <path
                        fill="#B2A7F0"
                        d="M266.318 190.25c3.204-.718 4.114-9.088 2.949-14.067-1.164-4.978-2.221-6.666-3.108-8.999-.87-2.35-6.109-3.087-6.239 1.196q1.021 3.931 1.591 5.521-.466.291-3.47 3.221c-1.264 1.233-2.888 6.14.067 9.933 3.106 3.987 5.006 3.912 8.21 3.195z"></path>
                </g>
                <g>
                    <path
                        fill="#DBD5FF"
